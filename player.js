...
function initializePlayer(client) {
    ...
    client.riffy.on("trackStart", async (player, track) => {
        ...
        const embed = new EmbedBuilder()
            ...
            .setDescription(`<a:nhay:1246437179647856671> **Tên Nhạc:** [${track.info.title}](${track.info.uri})\n <:sohuu:1246438340060905512> **Ca Sĩ:** ${track.info.author}\n <a:music:1246437360749641838> **Nền Tảng:** YouTube, Spotify, SoundCloud`)
            ...
            .setTimestamp()
            .setFooter({ text: 'Bot được code bởi MK' });
